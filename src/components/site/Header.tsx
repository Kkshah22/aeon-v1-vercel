      ...
      <div className="mx-auto max-w-[1600px] px-6 lg:px-10">
        <div className="grid grid-cols-3 items-center h-16 lg:h-20">
          <nav className="hidden lg:flex items-center gap-8 text-xs tracking-[0.18em] uppercase">
            <Link to="/shop" className="editorial-link">Shop</Link>
          ...
          <Link to="/" className="text-center font-display text-3xl tracking-[0.4em] lg:text-4xl">
            AEON
          </Link>
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 bg-paper z-50 flex flex-col fade-in-up">
          <div className="flex items-center justify-between h-16 px-6 border-b border-border">
            <span className="font-display text-2xl tracking-[0.4em]">AEON</span>
          ...
          <nav className="flex-1 flex flex-col gap-8 p-10 text-2xl font-display">
            ...
            <Link to="/about" onClick={() => setOpen(false)} className="text-base eyebrow">About</Link>
            <Link to="/contact" onClick={() => setOpen(false)} className="text-base eyebrow">Contact</Link>
            <Link to="/wishlist" onClick={() => setOpen(false)} className="text-base eyebrow">Wishlist</Link>
          </nav>
        </div>
      )}
    </header>
